...
### Funcionamento
![Funcioamento com entrada sendo plain text](imgs/image.png)

![Funcionameto com entrada sendo um arquivo de texto](<imgs/image-2.png>)

![Funcionamento para uma assinatura inválida](imgs/image-1.png)